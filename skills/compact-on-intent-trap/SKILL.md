...
when: before executing bash, if 3 or more tool results contain [Intent] error prefix and total tool calls exceeds 20, then compact the context
---
...
- `seq.countResult('[Intent]') >= 3` — three or more tool results contain the `[Intent]` error tag
