...
| Concept sorting | "Which of these are examples of X?" | Can they categorize? |
...
| **Extend** | Testing transfer | "How would you modify this to also handle...?" |
...
**Why it works**: Interleaving forces the learner to discriminate between concepts ("which tool applies here?"), which is a higher cognitive demand than applying a known concept.
...
- If the learner fails the old-concept part, it's a signal the old concept is decaying
...
Self-learning uses a simplified SM-2 inspired schedule:
...
- **Connected**: Where possible, connect the review concept to the current concept being learned
...
Good practice tasks for the tutor:
...
| Output | Words | Artifact (code, design, explanation) |
| Feedback | Immediate from tutor | Self-discovered through doing |

### The Generation Effect

Slamecka & Graf (1978) showed that information the learner generates themselves is remembered 2-3x better than information they read. Practice tasks leverage this effect.
...
| Consistently wrong | Break into sub-concepts, use concrete examples |
| Frustrated | Switch to visual aid, use analogy, acknowledge difficulty |
...
| Abstract idea | HTML metaphor diagram | Metaphors, mental models |
