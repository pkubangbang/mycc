...
interface IpcResponse {
  type: 'db_result' | 'wt_result' | 'team_result' | 'question_result' | 'grant_result' | 'core_result' | 'wiki_result';
  reqId: number;
  success: boolean;
  data?: unknown;
  error?: string;
 ...
 */
const RESPONSE_TYPES = new Set(['db_result', 'wt_result', 'team_result', 'question_result', 'grant_result', 'core_result', 'wiki_result']);
